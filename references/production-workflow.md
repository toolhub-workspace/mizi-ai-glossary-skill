...
- Preserve a large natural negative-space region for typography. Vary its position to suit each scene.
...
- Use one gray definition and one larger orange analogy. Do not add small metadata, repeated brand marks, cards, badges, or page numbers.
...
3. Inspect the contact sheet for repeated cats, clutter, rigid templating, visual imbalance, and concept mismatch.
...
6. Reject accidental generated text, punctuation-only lines, weak contrast, tiny body text, vector-like arrows, corner metadata, malformed paws, or neutral expressions.
